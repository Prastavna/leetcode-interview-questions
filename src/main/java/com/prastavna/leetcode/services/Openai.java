...
public class Openai {
  ...
  private final String prompt = """
    ...
    4. Company name, role, years of experience (yoe), and date must come directly from the post if present, otherwise leave them empty or default. Compnay name should not be something generic like `Company`, `MNC`, `Startup` etc.  Role can be empty but keep in mind that come compnaies like Microsoft have roles like L60, L61 etc.
